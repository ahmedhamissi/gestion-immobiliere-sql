...
--Insertion de logement
INSERT INTO Gestion.Logements (idLogement, idImmeuble, idInclusion, nbPieces, balcon, statut, noPorte, description)
VALUES (18,5,5,4,False,'Loué',5, NULL);
--Insertion locataire test
...
INSERT INTO Gestion.Logements(idLogement, idImmeuble, idInclusion, nbPieces, balcon, statut, noPorte, description)
VALUES (35, 5, 5, 4, FALSE, 'Vacant', 20, 'Logement de test');
-- Création du locataire avec solde NULL
INSERT INTO Gestion.Locataires(idLocataire, idLogement, langue, noTelephone, prenom, nom, courriel, modePaiement, solde)
VALUES (201, 35, 'Français', '4371152227', 'Test', 'SansSolde', 'courriel@test', 'Comptant', NULL);
...
--Création du  logement de test:
INSERT INTO Gestion.Logements(idLogement, idImmeuble, idInclusion, nbPieces, balcon, statut, noPorte, description)
VALUES (36, 5, 5, 4, FALSE, 'Vacant', 20, 'Logement de test');

-- Création du locataire avec solde = -2000.00 (si loyer = 1000.00)
INSERT INTO Gestion.Locataires(idLocataire, idLogement, langue, noTelephone, prenom, nom, courriel, modePaiement, solde)
VALUES (301, 36, 'Français', '4371152227', 'Test', 'Gratuit', 'courriel@test', 'Comptant', -2000.00);
...
--Insertion d'un paiement test RIEN NE BLOQUE 
...
--Le bail n'existe pas RETOURNE NULL
...
--Test sur un locataire qui n'existe pas NULL
